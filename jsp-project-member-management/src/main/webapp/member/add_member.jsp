...
<div class="container">
    <form name="formMemberInsert" class="form-horizontal" action="process_add_member.jsp" method="post"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            btnIsDuplication.addEventListener('click', function () {
                const id = formMemberInsert.id.value;	//아이디 input 에 있는 값
                if (id === "") {
                    alert('아이디를 입력해주세요');
                    formMemberInsert.id.focus();
                    return;
                }
                //아이디 중복 확인을 위해 팝업을 띄움.
                window.open('popup_id_check.jsp?id=' + id, 'IdCheck', 'width = 500, height = 500, top = 100, left = 200, location = no');
            });
            ...
            btnIsDuplication2nd.addEventListener('click', function () {
                ...
                xhr.open('GET', 'ajax_id_check.jsp?id=' + id);	//HTTP 요청 초기화. 통신 방식과 url 설정
